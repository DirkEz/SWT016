...
if(isset($_POST['submitID'])){
    ...
    $sql = "INSERT INTO submits(email, artists, public_title, discord, genre, bpm, instagram, link, comment)
    VALUES (:submit_email, :submit_artists, :submit_publicname, :submit_discord, :submit_genre, :submit_bpm, :submit_insta, :submit_link, :submit_comment)";
...
<body>
    ...
    <div class="submit-box">
        <form action="#" method="POST">
            ...
            <label>Email*</label>
            <input class="inp" type="email" name="submit_email" placeholder="Email">
            <label>Artist(s)*</label>
            <input class="inp" type="text" name="submit_artists" placeholder="Artist(s) (Artist1, Artist2, ...)">
            <label>Genre*</label>
            <input class="inp" type="text" name="submit_genre" placeholder="Genre">
            <label>Link*</label>
            <input class="inp" type="text" name="submit_link" placeholder="Link">
